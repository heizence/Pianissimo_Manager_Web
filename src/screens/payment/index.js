    ...
    if (!StudentName) {
      ...
      axios({
        ...
        headers: {
          ...
          Authorization: "KakaoAK 6b15e93c3130f6c2fa45a9fd260184dc",
        ...
        params: {
          ...
          approval_url: "http://localhost:3000/kakaopayRedirect/success", // 결제 성공 시 redirect url
          cancel_url: "http://localhost:3000/kakaopayRedirect/cancel", // 결제 취소 시 redirect url
          fail_url: "http://localhost:3000/kakaopayRedirect/fail", // 결제 실패 시 redirect url
        },
      }).then(
        (response) => {
          // 응답에서 필요한 data만 뽑는다.
      ...
      <div id="PaymentMain_inputSection">
        <div>
          ...
          <div className="PaymentMain_eachInputSection">
            ...
            {/* 연습실 이용권 checkbox */}
            <div
              className="PaymentMain_inputSection"
              id="PaymentMain_checkboxDiv"
            >
              <div
                className="PaymentMain_eachCheckbox"
                onClick={() => SetTicketType("연습실")}
              >
                <input
                  type="checkbox"
                  checked={TicketType === "연습실"}
                  readOnly
                />
                <span>연습실 이용권</span>
              </div>
              ...
              <div
                className="PaymentMain_eachCheckbox"
                onClick={() => SetTicketType("레슨")}
              >
                <input
                  type="checkbox"
                  checked={TicketType === "레슨"}
                  readOnly
                />
                <span>레슨 이용권</span>
              </div>
          ...
          <div className="PaymentMain_eachInputSection">
            ...
            <div className="PaymentMain_inputSection">
              <select
                id="PaymentMain_dropdownBtn"
                name="months"
                onChange={(e) => SetTicketMonth(e.target.value)}
              >
